...
const Color APP_PRIMARY_COLOR = Color(0xFF205ECA);
...
const Color APP_TEXT_COLOR = Color(0xFF1B1B1B);
const Color APP_PRIMARY_TEXT_COLOR = Color(0xFF205ECA);
...
const Color APP_PRIMARY_ICON_COLOR = Color(0xFF205ECA);
const Color APP_ICON_COLOR = Color(0xFF1B1B1B);
const Color APP_ACCENT_ICON_COLOR = Color(0xFFFFFFFF);
const Color APP_ERROR_COLOR = Color(0xFFD83831);
const Color APP_DIVIDER_COLOR = Color(0xFF1B1B1B);
